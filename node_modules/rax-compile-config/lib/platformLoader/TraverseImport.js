...
module.exports = function traverseImport(options, inputSource, sourceMapOption) {
  ...
  try {
    ast = babelParser.parse(inputSource, {
      sourceType: 'module',
      plugins: ['jsx', 'typescript', 'classProperties', 'objectRestSpread', 'optionalCatchBinding', 'dynamicImport', 'decorators-legacy', 'asyncGenerators', 'exportDefaultFrom', 'exportNamespaceFrom', 'optionalCatchBinding', 'throwExpressions', 'optionalChaining', 'nullishCoalescingOperator']
    });
  } catch (err) {
