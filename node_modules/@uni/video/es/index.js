...
export var chooseVideo = function chooseVideo(args) {
  if (isWeb) {
...
export var createVideoContext = function createVideoContext(id, context) {
  if (isWeb) {
...
export var chooseMedia = function chooseMedia(args) {
  if (isWeb) {
