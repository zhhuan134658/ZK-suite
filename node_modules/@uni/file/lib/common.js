...
var normalize = {
  upload: function upload(api, containerName) {
    return function (options) {
      ...
      var afterOptions = _extends({}, DEFAULT_REQUEST_OPTIONS, (0, _styleOptions.styleIn)(options, containerName));
  ...
  getInfo: function getInfo(api, containerName) {
    ...
    return function (options) {
      ...
      return (0, _promisify.promisify)(api)(afterOptions).then(function (res) {
  ...
  getSavedInfo: function getSavedInfo(api, containerName) {
    return function (options) {
      ...
      return (0, _promisify.promisify)(api)(afterOptions);
    };
  },
  getSavedList: function getSavedList(api, containerName) {
    ...
    return function (options) {
      ...
      return (0, _promisify.promisify)(api)(afterOptions).then(formatRes);
    };
  },
