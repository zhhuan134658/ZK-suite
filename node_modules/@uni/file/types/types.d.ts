...
export declare type UploadProgressUpdateCallback = (res: UploadProgressUpdateRes) => void;
export declare type UploadHeadersReceivedCallback = (header: any) => void;
...
declare type onProgressUpdateCb = () => OnProgressUpdateCbRes;
