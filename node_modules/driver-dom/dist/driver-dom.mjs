...
export { addEventListener, afterRender, appendChild, beforeRender, createBody, createElement, createEmpty, createText, insertAfter, insertBefore, removeAttribute, removeChild, removeChildren, removeEventListener, replaceChild, setAttribute, setStyle, setTagNamePrefix, setUnitPrecision, setViewportWidth, updateText };
//# sourceMappingURL=driver-dom.mjs.map
