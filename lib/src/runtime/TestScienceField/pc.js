...
var FormField = {
    ...
    methods: function () {
        ...
        return {
            ...
            handleSave: function (row) {
                ...
                if (row.price) {
                    var newSub = row.price * row.wz_number;
    ...
    fieldRender: function () {
        ...
        return (React.createElement("div", { className: "TestScienceField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement("div", { style: { marginTop: '10px' } },
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement(ImportDialog, { columns: columns, binding: this, setTableData: this.methods().handleSetTableData, bizAlias: "TestScience" }))),
                React.createElement(Modal, { className: "isvzhukuaiwarehousing", title: "\u9009\u62E9\u7269\u8D44", width: 1000, visible: this.state.isModalVisibletree, footer: [
                    ...
                    React.createElement(Layout, null,
                        ...
                        React.createElement(Content, null,
                            ...
                            React.createElement(Pagination, { defaultCurrent: 1, total: this.state.total3, hideOnSinglePage: true, className: "pagination", onChange: this.methods().handleTreeChangePage })))))));
    },
