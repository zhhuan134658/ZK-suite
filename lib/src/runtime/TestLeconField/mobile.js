            ...
            onChangedata1: function (data, index) {
                ...
                if (arr[index].plan_in_riqi && arr[index].plan_out_riqi) {
                    ...
                    if (timenum_1 === 0) {
                        ...
                        _this.setState({ datenum: timenum_1 });
                    }
                    else {
                        _this.setState({ datenum: timenum_1, materialList: __spreadArray([], arr, true) }, function () {
                            if (arr[newindex].zl_number && arr[newindex].price) {
                                arr[newindex].subtotal = (arr[newindex].zl_number *
                                    arr[newindex].price *
                                    Number(timenum_1)).toFixed(2);
                            }
                            else {
                                arr[newindex].subtotal = 0;
                            }
                                                            ...
                                                            React.createElement("div", { className: "m-field-wrapper" },
                                                                React.createElement("div", { className: "m-field m-field-mobile m-select-field" },
                                                                    ...
                                                                    React.createElement("div", { className: "m-field-box" },
                                                                        React.createElement("div", { className: "m-field-content left" },
                                                                            React.createElement("div", { className: "input-wrapper" },
                                                                                React.createElement(InputItem, { editable: false, clear: true, value: item.plan_in_riqi, placeholder: "\u8BF7\u9009\u62E9" })))))))))),
                                            React.createElement("div", null,
                                                React.createElement(DatePicker, { mode: "date", title: "Select Date", extra: "Optional", value: _this_1.state.datadate2, onChange: function (date) {
                                                            ...
                                                            React.createElement("div", { className: "m-field-wrapper" },
                                                                React.createElement("div", { className: "m-field m-field-mobile m-select-field" },
                                                                    ...
                                                                    React.createElement("div", { className: "m-field-box" },
                                                                        React.createElement("div", { className: "m-field-content left" },
                                                                            React.createElement("div", { className: "input-wrapper" },
                                                                                React.createElement(InputItem, { editable: false, clear: true, value: item.plan_out_riqi, placeholder: "\u8BF7\u9009\u62E9" })))))))))),
                                            React.createElement("div", null,
                                                React.createElement("div", { className: "field-wrapper" },
                                                    React.createElement("div", { className: "m-group m-group-mobile" },
                                                        React.createElement("div", { className: "m-field-wrapper" },
                        ...
                        React.createElement("div", { className: "m-field-wrapper" },
                            React.createElement("div", { className: "m-field m-field-mobile m-select-field" },
                                ...
                                React.createElement("div", { className: "m-field-box" },
                                    React.createElement("div", { className: "m-field-content left" },
                                        React.createElement("div", { className: "input-wrapper" },
                                            React.createElement(InputItem, { editable: false, value: this.state.Inputmoney1, placeholder: "\u81EA\u52A8\u8BA1\u7B97", readOnly: true })))))))),
