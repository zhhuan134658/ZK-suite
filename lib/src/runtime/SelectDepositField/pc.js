...
var FormField = {
    ...
    fieldRender: function () {
        ...
        return (React.createElement("div", { className: "SelectDepositField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement("div", null,
                    React.createElement(Input, { readOnly: true, value: this.state.Inputvalue, onClick: this.methods().handleAdd, placeholder: "\u8BF7\u9009\u62E9\u9879\u76EE", suffix: React.createElement(CloseCircleOutlined, { onClick: this.methods().iconClick, style: { color: 'rgba(0,0,0,.45)' } }) })),
                React.createElement(Modal, { className: "isvzhukuaiwarehousing", title: "\u9009\u62E9\u9879\u76EE", width: 1000, visible: this.state.isModalVisible, footer: [
