...
var mycolumnsa = [
    ...
    },
    {
        title: '租赁单位',
        dataIndex: 'supplier',
        render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.supplier },
            React.createElement("span", null, record.supplier))); },
    },
    {
        title: '结算金额（取结算中的批复金额）',
        dataIndex: 'reply_money',
        render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.reply_money },
            React.createElement("span", null, record.reply_money))); },
    },
];
var mycolumnsb = [
    {
    ...
    },
    {
        ...
        render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.contract_money },
            React.createElement("span", null, record.contract_money))); },
    },
];
var mycolumnsc = [
    {
    ...
    },
    {
        ...
        render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.detailed_money },
            React.createElement("span", null, record.detailed_money))); },
    },
];
var FormField = {
    ...
    fieldRender: function () {
        ...
        var rowSelection = {
            ...
            onChange: function (selectedRowKeys, selectedRows) {
                ...
                _this_1.setState({ currentSelectData: newData, detailname: dtar });
        ...
        return (React.createElement("div", { className: "TestRegistField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement(Modal, { className: "isvzhukuaiwarehousing", title: "\u5173\u8054", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    React.createElement(Tabs, { className: "Tabs_class", defaultActiveKey: "a", centered: true, onChange: Tabschange },
                        React.createElement(TabPane, { tab: "\u79DF\u8D41\u5408\u540C", key: "b" },
                            ...
                            React.createElement(Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection), rowKey: function (record) { return record.id; }, columns: mycolumnsb, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                        ...
                        React.createElement(TabPane, { tab: "\u79DF\u8D41\u7ED3\u7B97", key: "a" },
                            React.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: function (val) {
                            ...
                            React.createElement(Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection), rowKey: function (record) { return record.id; }, columns: mycolumnsa, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                            React.createElement(Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })),
                        React.createElement(TabPane, { tab: "\u673A\u68B0\u8D39\u7ED3\u7B97", key: "c" },
                            React.createElement(Search, { placeholder: "\u8BF7\u8F93\u5165", allowClear: true, enterButton: "\u641C\u7D22", size: "large", onSearch: function (val) {
                            ...
                            React.createElement(Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection), rowKey: function (record) { return record.id; }, columns: mycolumnsc, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                            React.createElement(Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.onChangepage })))))));
    },
};
