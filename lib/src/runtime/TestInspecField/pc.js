...
var FormField = {
    ...
    fieldRender: function () {
        ...
        var required = form.getFieldProp('TestInspec', 'required');
        ...
        var deColumns = [
            ...
            },
            {
                ...
                render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.check_situation },
                    React.createElement("span", null, record.check_situation))); },
            },
            {
                title: '整改措施',
                dataIndex: 'rectify',
                render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.rectify },
                    React.createElement("span", null, record.rectify))); },
            },
        ];
        var etColumns = [
            {
            ...
            },
            {
                ...
                render: function (_, record) {
                    return (React.createElement(Input, { value: record.check_situation, placeholder: "\u8BF7\u8F93\u5165", onChange: function (e) {
            ...
            },
            {
                ...
                editable: false,
                render: function (_, record) {
                    return (React.createElement(Input, { value: record.rectify, placeholder: "\u8BF7\u8F93\u5165", onChange: function (e) {
        ...
        return (React.createElement("div", { className: "TestInspecField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement("div", { style: { marginTop: '10px' } },
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement(ImportDialog, { columns: columns, binding: this, setTableData: this.methods().handleSetTableData, bizAlias: "TestInspec" }))),
