...
var FormField = {
    ...
    fieldRender: function () {
        ...
        var field = form.getFieldInstance('TestBidzhi');
        var label = form.getFieldProp('TestBidzhi', 'label');
        var required = form.getFieldProp('TestBidzhi', 'required');
        ...
        form.onFieldExtendValueChange('TestBidzhi', function (value) {
            _this_1.setState({
                Inputvalue: value,
            });
        });
        ...
        return (React.createElement("div", { className: "TestBidzhiField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement(Modal, { className: "isvzhukuaiwarehousing", title: "\u5173\u8054\u6295\u6807\u652F\u51FA\u7533\u8BF7", width: 1000, visible: this.state.isModalVisible, footer: [
