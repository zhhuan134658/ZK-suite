...
var FormField = {
    ...
    asyncSetFieldProps: function (data) {
        var _this = this;
        var bizAlias = 'SelectLao';
        var promise = asyncSetProps(_this, data, bizAlias, 'service_progresspay_declaration');
    ...
    fieldRender: function () {
        ...
        return (React.createElement("div", { className: "SelectLaoField_class" },
