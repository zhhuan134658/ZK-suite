...
var FormField = {
    ...
    asyncSetFieldProps: function (data) {
        var _this = this;
        var bizAlias = 'SelectHe';
        var projectName = _this.props.form.getFieldValue('SelectDeposit');
        var bonType = _this.props.form.getFieldValue('RadioField');
        data.project_name = projectName;
        data.bond_type = bonType;
        var promise = asyncSetProps(_this, data, bizAlias, 'bond_payment_register', null, 'Selectbaopro');
    ...
    fieldRender: function () {
        ...
        return (React.createElement("div", { className: "SelectHeField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement(Modal, { className: "isvzhukuaizkgl", title: "\u9009\u62E9\u5408\u540C", width: 1000, visible: this.state.isModalVisible, footer: [
