...
var FormField = {
    ...
    asyncSetFieldProps: function (data) {
        var _this = this;
        var bizAlias = 'SelectCon';
        var promise = asyncSetProps(_this, data, bizAlias, 'lease_completion_settlement');
    ...
    fieldRender: function () {
        ...
        return (React.createElement("div", { className: "SelectConField_class" },
