...
var FormField = {
    ...
    fieldDidUpdate: function () {
        if (!this.props.runtimeProps.viewMode) {
            ...
            var str0 = '设备名称  单位  规格型号  总计划量  使用部位  备注';
            var str1 = '\n';
    ...
    fieldRender: function () {
        ...
        var deColumns = [
            ...
            },
            {
                title: '使用部位',
                dataIndex: 'position',
                render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.position },
                    React.createElement("span", null, record.position))); },
            },
            {
                title: '备注',
                dataIndex: 'remarks',
        ...
        var etColumns = [
            ...
            },
            {
                title: '使用部位',
                dataIndex: 'position',
                render: function (_, record, index) { return (React.createElement(Input, { value: record.position, placeholder: "\u8BF7\u8F93\u5165", onChange: function (e) {
                        var newData = _this_1.state.dataSource;
                        newData[index].position = e.target.value;
                        _this_1.setState({ dataSource: newData });
                    } })); },
            },
            {
                title: '备注',
        ...
        return (React.createElement("div", { className: "TestPlanField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement("div", { style: { marginTop: '10px' } },
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement(ImportDialog, { columns: columns, binding: this, setTableData: this.methods().handleSetTableData, bizAlias: "TestPlan" }))),
