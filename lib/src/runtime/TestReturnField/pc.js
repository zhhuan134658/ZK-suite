...
var FormField = {
    ...
    asyncSetFieldProps: function (data) {
        var _this = this;
        var bizAlias = 'TestReturn';
        var promise = asyncSetProps(_this, data, bizAlias, 'material_contract');
        promise
            .then(function (res) {
    ...
    fieldRender: function () {
        var _this_1 = this;
        var form = this.props.form;
        var field = form.getFieldInstance('TestReturn');
        var label = form.getFieldProp('TestReturn', 'label');
        var required = form.getFieldProp('TestReturn', 'required');
        ...
        var rowSelection = {
            ...
            onChange: function (selectedRowKeys, selectedRows) {
                ...
                form.setFieldExtendValue('CorpSupplieryi', newData[0] ? newData[0]['supplier'] : '');
                _this_1.setState({
                    currentSelectData: newData,
                    currentSelectDataid: newDataid,
                    detailname: dtar,
        ...
        return (React.createElement("div", { className: "TestReturnField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement("div", { style: { marginTop: '10px' } },
                    ...
                    React.createElement(Button, { onClick: this.methods().handleDetailAdd, type: "primary", style: { marginBottom: 16, marginTop: 16 } }, "\u6DFB\u52A0\u660E\u7EC6"),
                    React.createElement("div", { className: "label", style: { marginTop: '10px' } }, "\u4E0D\u542B\u7A0E\u91D1\u989D\u5408\u8BA1(\u5143)"),
                    React.createElement("div", null,
                ...
                React.createElement(Modal, { className: "isvzhukuaizkgl", title: "\u5173\u8054", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    React.createElement(Tabs, { className: "Tabs_class", defaultActiveKey: "a", centered: true, onChange: Tabschange },
                        ...
                        React.createElement(TabPane, { tab: "\u91C7\u8D2D\u8BA2\u5355", key: "b" },
                            ...
                            React.createElement(Table, { scroll: { x: '1500px' }, rowSelection: __assign({ type: 'radio' }, rowSelection), className: "full-size-editable", rowKey: function (record) { return record.id; }, columns: columnsNew, dataSource: this.state.listData, loading: this.state.loading, pagination: false }),
                            React.createElement(Pagination, { defaultCurrent: 1, total: this.state.total2, hideOnSinglePage: true, className: "pagination", onChange: this.methods().handleChangePage })))),
