...
var myColumns = [
    {
        title: (React.createElement("div", null, "\u7ED3\u7B97\u4E3B\u9898")),
        dataIndex: 'name',
...
var FormField = {
    ...
    fieldRender: function () {
        ...
        return (React.createElement("div", { className: "TestMaterField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement(Modal, { className: "isvzhukuaizkgl", title: "\u5173\u8054", width: 1000, visible: this.state.isModalVisible, footer: [
                    ...
                    React.createElement(Tabs, { className: "Tabs_class", defaultActiveKey: "a", centered: true, onChange: Tabschange },
                        React.createElement(TabPane, { tab: "\u6750\u6599\u7ED3\u7B97", key: "a" }),
                        React.createElement(TabPane, { tab: "\u91C7\u8D2D\u5408\u540C", key: "b" }),
                        React.createElement(TabPane, { tab: "\u91C7\u8D2D\u8BA2\u5355 ", key: "c" }),
                        React.createElement(TabPane, { tab: "\u6750\u6599\u5165\u5E93", key: "d" })),
