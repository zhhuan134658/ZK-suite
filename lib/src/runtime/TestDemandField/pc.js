    ...
    fieldRender: function () {
        ...
        var deColumns = [
            ...
            },
            {
                ...
                render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.need_number },
                    React.createElement("span", null, record.need_number))); },
            },
            {
                title: '备注',
                dataIndex: 'remarks',
        ...
        return (React.createElement("div", { className: "TestDemandField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement("div", { style: { marginTop: '10px' } },
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement(ImportDialog, { columns: columns, binding: this, setTableData: this.methods().handleSetTableData, bizAlias: "TestDemand" }))),
