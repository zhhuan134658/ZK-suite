        ...
        return {
            ...
            handleSave: function (row) {
                ...
                if (reg.test(row.price) && reg.test(row.oil_consump)) {
                    var total = Number(row.price) * Number(row.oil_consump);
    ...
    fieldRender: function () {
        ...
        var deColumns = [
            ...
            },
            {
                ...
                render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.oil_consump },
                    React.createElement("span", null, record.oil_consump))); },
            },
            {
                title: '油价(元)',
                dataIndex: 'price',
        ...
        return (React.createElement("div", { className: "TestOliField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement("div", { style: { marginTop: '10px' } },
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement(ImportDialog, { columns: columns, binding: this, setTableData: this.methods().handleSetTableData, bizAlias: "TestOli" })),
                    React.createElement("div", { className: "label", style: { marginTop: '10px' } }, "\u5408\u8BA1(\u5143)"),
                    React.createElement("div", null,
