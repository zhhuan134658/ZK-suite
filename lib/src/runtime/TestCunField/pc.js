...
var FormField = {
    ...
    methods: function () {
        ...
        return {
            ...
            handleProjectAdd: function (crophouse) {
    ...
    handleOk: function () {
        ...
        var crophouse = this.state.crophouse;
        if (crophouse === 'out') {
    ...
    fieldRender: function () {
        ...
        var deColumns = [
            ...
            },
            {
                title: '库存数量',
                dataIndex: 'ku_cun',
                render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.ku_cun },
                    React.createElement("span", null, record.ku_cun))); },
            },
            {
                title: '不含税单价(元)',
        ...
        if (this.props.runtimeProps.viewMode) {
            ...
            // }
            var _b = value ? value : {}, _c = _b.warehouse, warehouse = _c === void 0 ? '' : _c, _d = _b.warehousein, warehousein = _d === void 0 ? '' : _d, _e = _b.detailedData, detailedData = _e === void 0 ? [] : _e;
            return (React.createElement("div", { className: "field-wrapper" },
                React.createElement("div", { className: "label", style: { marginTop: '10px' } }, "\u8C03\u51FA\u4ED3\u5E93"),
                React.createElement("div", null, warehouse),
                React.createElement("div", { className: "label", style: { marginTop: '10px' } }, "\u8C03\u5165\u4ED3\u5E93"),
                React.createElement("div", null, warehousein),
        ...
        return (React.createElement("div", { className: "TestCunField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                React.createElement("div", null,
                    ...
                    React.createElement(Input, { onClick: this.methods().handleProjectAdd.bind(this, 'out'), readOnly: true, value: this.state.detailname, placeholder: "\u8BF7\u9009\u62E9", suffix: React.createElement(CloseCircleOutlined, { onClick: this.methods().iconClick.bind(this, 'out'), style: { color: 'rgba(0,0,0,.45)' } }) })),
                React.createElement("div", { style: { marginTop: '10px' } },
                    React.createElement("div", { className: "label", style: { marginTop: '10px' } },
                        required ? (React.createElement("span", { style: { color: '#ea6d5c' } }, "*")) : (React.createElement("span", { style: { color: '#fff' } }, "*")),
                        "\u8C03\u5165\u4ED3\u5E93"),
                    React.createElement(Input, { onClick: this.methods().handleProjectAdd.bind(this, 'in'), readOnly: true, value: this.state.detailnamein, placeholder: "\u8BF7\u9009\u62E9", suffix: React.createElement(CloseCircleOutlined, { onClick: this.methods().iconClick.bind(this, 'in'), style: { color: 'rgba(0,0,0,.45)' } }) })),
                React.createElement("div", { style: { marginTop: '10px' } },
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement(ImportDialog, { columns: columns, binding: this, setTableData: this.methods().handleSetTableData, bizAlias: "TestCun" })),
                ...
                React.createElement(Modal, { className: "isvzhukuaizkgl", title: "\u9009\u62E9\u4ED3\u5E93", width: 1000, visible: this.state.isModalVisible, footer: [
