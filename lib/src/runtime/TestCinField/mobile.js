...
var FormField = {
    ...
    asyncSetFieldProps: function (data, type, updateCascade) {
        ...
        var _this = this;
        var promise = asyncSetProps(_this, data, 'TestCin', 'material_warehousing');
        ...
        var checkdebar = (React.createElement("div", { style: { width: '100vw' } },
            ...
            React.createElement(Tabs, { tabs: tabs, initialPage: 0, onChange: function (tab, index) {
                ...
                React.createElement("div", null,
                    React.createElement(FancyList, { data: parseListData(this.state.checkData, parsers.materialPlan), itemClick: this.methods().checkClick })),
                React.createElement("div", null,
                    React.createElement(FancyList, { data: parseListData(this.state.checkData, parsers.purchaseAppliance), itemClick: this.methods().checkClick })),
                React.createElement("div", null,
                    React.createElement(FancyList, { data: parseListData(this.state.checkData, parsers.purchaseContract), itemClick: this.methods().checkClick })),
                React.createElement("div", null,
                    React.createElement(FancyList, { data: parseListData(this.state.checkData, parsers.purchaseOrder), itemClick: this.methods().checkClick })))));
                                                    ...
                                                    React.createElement("div", { className: "m-group m-group-mobile" },
                                                        React.createElement("div", { className: "m-field-wrapper" },
                                                            React.createElement("div", { className: "m-field m-field-mobile m-select-field" },
                                                                React.createElement("div", { className: "m-field-head" },
                                                                    React.createElement("div", { className: "m-field-label" },
                                                                        React.createElement("span", null, "\u5DF2\u5165\u5E93\u91CF"))),
                                                                React.createElement("div", { className: "m-field-box" },
                                                                    React.createElement("div", { className: "m-field-content left" },
                                                                        React.createElement("div", { className: "input-wrapper" },
                                                                            React.createElement(InputItem, { editable: false, clear: true, value: item.quantity_rk, placeholder: "\u81EA\u52A8\u83B7\u53D6" }))))))))),
                                            React.createElement("div", null,
                                                React.createElement("div", { className: "field-wrapper" },
                                                    React.createElement("div", { className: "m-group m-group-mobile" },
                                                        React.createElement("div", { className: "m-field-wrapper" },
                                                            React.createElement("div", { className: "m-field m-field-mobile m-select-field" },
                                                                ...
                                                                React.createElement("div", { className: "m-field-box" },
                                                                    React.createElement("div", { className: "m-field-content left" },
                                                                        React.createElement("div", { className: "input-wrapper" },
                                                                            React.createElement(InputItem, { editable: false, clear: true, value: item.quantity_zong, placeholder: "\u81EA\u52A8\u83B7\u53D6" }))))))))))))));
                        }),
