...
var FormField = {
    ...
    asyncSetFieldProps: function (data) {
        console.log('TEST');
        var _this = this;
        var promise = asyncSetProps(_this, data, 'CorpSupplieryi');
        promise
            .then(function (res) {
    ...
    fieldRender: function () {
        ...
        return (React.createElement("div", { className: "CorpSupplieryi_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement(Modal, { className: "isvzhukuaiwarehousing", title: "\u9009\u62E9\u4F9B\u5E94\u5546", width: 1000, visible: this.state.isModalVisible, footer: [
                ...
                React.createElement(Modal, { className: "isvzhukuaiwarehousing", onCancel: this.methods().hideModal, visible: this.state.visibleModal, width: 1000, title: "\u65B0\u589E", footer: null },
