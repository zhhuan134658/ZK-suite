...
import { deleteRowForTaxCalcTables, handleTaxTableStatistics, } from '../../components/handleTables';
...
var FormField = {
    ...
    asyncSetFieldProps: function (data) {
        var _this = this;
        var bizAlias = 'TestApplication';
        var promise = asyncSetProps(_this, data, bizAlias, 'material_requirement_plan');
        promise
            .then(function (res) {
    ...
    fieldDidUpdate: function () {
        if (!this.props.runtimeProps.viewMode) {
            ...
            var str1 = ' 合计(元):' + this.state.Inputmoney1;
            var str = str2 + parsePrintString(newlistdata, applicationColumns, str1);
            console.log(str);
    ...
    fieldRender: function () {
        ...
        var deColumns = [
            ...
            },
            {
                ...
                render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.need_quantity },
                    React.createElement("span", null, record.need_quantity))); },
            },
            {
                title: '累计申请量',
                dataIndex: 'quantity_sq',
                render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.quantity_sq },
                    React.createElement("span", null, record.quantity_sq))); },
            },
            {
                title: '总计划量',
            ...
            },
            {
                ...
                render: function (_, record) { return (React.createElement(Tooltip, { placement: "topLeft", title: record.refer_price },
                    React.createElement("span", null, record.refer_price))); },
            },
            {
                title: '小计(元)',
                dataIndex: 'subtotal',
        ...
        var etColumns = [
            ...
            },
            {
                ...
                editable: true,
                render: function (_, record) {
                    var n1 = Number(record.refer_price);
                    if (isNaN(n1)) {
                        record.judge = true;
                        return (React.createElement(Tooltip, { placement: "topLeft", title: "\u8BE5\u5355\u5143\u683C\u5E94\u8BE5\u4E3A\u6570\u5B57" },
                            React.createElement("span", { style: { color: '#ff0000' } }, record.refer_price)));
                    }
                    else {
                        return (React.createElement(Tooltip, { placement: "topLeft", title: record.refer_price },
                            React.createElement("span", null, record.refer_price)));
                    }
                },
            },
            ...
            },
            {
                ...
                isNumber: false,
                render: function (_, record) {
                    return (React.createElement(Tooltip, { placement: "topLeft", title: record.remarks },
                        React.createElement("span", null, record.remarks)));
                },
            },
            {
        ...
        if (this.props.runtimeProps.viewMode) {
            ...
            //   }
            var _b = value ? value : {}, _c = _b.detailname, detailname = _c === void 0 ? '' : _c, _d = _b.hanmoney, hanmoney = _d === void 0 ? 0 : _d, _e = _b.detailedData, detailedData = _e === void 0 ? [] : _e;
        ...
        return (React.createElement("div", { className: "TestApplicationField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                    ...
                    React.createElement("div", { className: "label", style: { display: 'flex', justifyContent: 'space-between' } },
                        ...
                        React.createElement("div", { style: { color: '#409EFF', cursor: 'pointer' } },
                            React.createElement(Popconfirm, { title: "\u662F\u5426\u91CD\u7F6E\uFF1F\u91CD\u7F6E\u540E\u660E\u7EC6\u8868\u683C\u5C06\u6E05\u7A7A\u3002", onConfirm: this.methods().ResetClick, okText: "\u662F", cancelText: "\u5426" },
                                React.createElement("span", null, "\u91CD\u7F6E123\u660E\u7EC6")))),
                ...
                React.createElement("div", { style: { marginTop: '10px' } },
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement(ImportDialog, { columns: columns, binding: this, setTableData: this.methods().handleSetTableData, bizAlias: "TestApplication" })),
                    React.createElement("div", { className: "label", style: { marginTop: '10px' } }, "\u5408\u8BA1(\u5143)"),
                    React.createElement("div", null,
