    ...
    fieldRender: function () {
        ...
        var onSelect = function (keys, info) {
            ...
            var treedata = {
                ...
                page: '1',
                rk_id: ['-1'],
                ck_name: _this_1.state.detailname,
            };
            _this_1.setState({
                allData: treedata,
            });
        ...
        if (this.props.runtimeProps.viewMode) {
            ...
            // }
            var _b = value ? value : {}, _c = _b.warehouse, warehouse = _c === void 0 ? '' : _c, _d = _b.detailedData, detailedData = _d === void 0 ? [] : _d;
        ...
        return (React.createElement("div", { className: "TestOutField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement("div", { style: { marginTop: '10px' } },
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement(ImportDialog, { columns: columns, binding: this, setTableData: this.methods().handleSetTableData, bizAlias: "TestOut" }))),
