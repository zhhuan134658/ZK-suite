...
var FormField = {
    ...
    asyncSetFieldProps: function (data, type, updateCascade) {
        ...
        var _this = this;
        var promise = asyncSetProps(_this, data, 'TestPur', 'material_contract');
        promise.then(function (res) {
            ...
            switch (type) {
                case 1:
                    _this.setState({
                        materialList: __spreadArray([], res.dataArray, true),
                    });
                    handleTaxTableStatistics(_this, res.dataArray);
                    break;
                case 2:
                    _this.setState({
                        checkData: __spreadArray([], res.dataArray, true),
                    });
    ...
    fieldDidUpdate: function () {
        if (!this.props.runtimeProps.viewMode) {
            ...
            var str1 = "\u4E0D\u542B\u7A0E\u91D1\u989D\u5408\u8BA1(\u5143)\uFF1A".concat(this.state.Inputmoney2, "\n \u542B\u7A0E\u91D1\u989D\u5408\u8BA1(\u5143)\uFF1A").concat(this.state.Inputmoney1);
            var str = str2 + parsePrintString(newlistdata, purColumns, str1);
            console.log(str);
        ...
        var checkdebar = (React.createElement("div", { style: { width: '100vw' } },
            ...
            React.createElement(Tabs, { tabs: tabs, initialPage: 0, renderTabBar: function (props) { return React.createElement(Tabs.DefaultTabBar, __assign({}, props, { page: 3 })); }, onChange: function (tab, index) {
                ...
                React.createElement("div", null,
                    React.createElement(FancyList, { data: parseListData(this.state.checkData, applicationParser), itemClick: this.methods().checkClick })),
                React.createElement("div", null,
                    React.createElement(FancyList, { data: parseListData(this.state.checkData, planParser), itemClick: this.methods().checkClick })))));
