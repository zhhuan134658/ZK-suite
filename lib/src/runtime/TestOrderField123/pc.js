...
var FormField = {
    ...
    methods: function () {
        ...
        return {
            ...
            updateTable: function (list) {
                var form = _this.props.form;
                var field = form.getFieldInstance('TableApplication');
                console.log('132486789', field);
                var dataSource = __spreadArray([], list, true);
    ...
    fieldRender: function () {
        ...
        return (React.createElement("div", { className: "TestOrderField_class" },
            React.createElement("div", { className: "pc-custom-field-wrap" },
                ...
                React.createElement("div", { style: { marginTop: '10px' } },
                    ...
                    React.createElement("div", { style: {
                        ...
                        React.createElement(ImportDialog, { columns: columns, binding: this, setTableData: this.methods().handleSetTableData, bizAlias: "TestOrder" })),
                    React.createElement("div", { className: "label", style: { marginTop: '10px' } }, "\u4E0D\u542B\u7A0E\u91D1\u989D\u5408\u8BA1(\u5143)"),
                    React.createElement("div", null,
