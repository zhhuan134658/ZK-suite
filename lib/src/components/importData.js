...
var ImportDialog = function (props) {
    ...
    return (React.createElement("div", null,
        ...
        React.createElement(Modal, { className: "isvzhukuaiwarehousing", visible: modalVisible, onCancel: handleCancel, width: 750, title: '导入数据', footer: React.createElement("span", { className: "steps-action" },
