...
var Suite = createReactClass({
    ...
    render: function () {
        ...
        return (React.createElement("div", { className: "isvzhukuaiwarehousing" },
            React.createElement("div", { className: "pc-runtime-wrap" }, this.props.form.getFields().map(function (field) {
                ...
                if (field.props.commonBizType === 'SelectDepositField' || field.props.commonBizType === 'SelectDeposit') {
                    return React.createElement(SelectDepositField, __assign({}, _this.props, { bizAlias: field.props.bizAlias }));
                }
